...
export const OurServices = () => {
  ...
  return (
    ...
    >
      ...
      >
        Intervenim rapid 24/7 pentru evacuare, tractare și asistență rutieră,
        oriunde în Chișinău.
      </p>
      ...
      <div className="grid w-full grid-cols-1 gap-6 pt-8 sm:grid-cols-2 md:items-start lg:grid-cols-3 xl:gap-10">
        <ServiceCard
          label={"Evacuare auto"}
          content={
            "Evacuare auto rapidă pentru mașini avariate, defecte sau blocate."
          }
        ...
        <ServiceCard
          ...
          content={
            "Tractare auto după accident, intervenție rapidă și transport sigur."
          }
        ...
        <ServiceCard
          ...
          content={
            "Transportăm automobile pe platformă, local sau în afara orașului."
          }
        ...
        <ServiceCard
          ...
          content={
            "Evacuare SUV-uri și microbuze cu platformă adaptată vehiculelor grele."
          }
        ...
        <ServiceCard
          ...
          content={
            "Asistență rutieră non-stop: baterie, pană, probleme minore."
          }
        ...
        <ServiceCard
          ...
          content={
            "Deblocare mașini și evacuare în caz de uși sau chei blocate."
          }
