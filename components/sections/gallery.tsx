    ...
    <section className="bg-[#F8FAFC]" id="gallery">
      ...
      >
          ...
          <div className="grid w-full grid-cols-2 gap-4 md:grid-cols-3 md:gap-6 lg:grid-cols-5">
            <div className="col-span-1 h-full drop-shadow-[0_3px_32px_rgba(0,0,0,0.08)] lg:col-span-2">
              <Image
                src={image1}
                alt={
                  "Evacuator auto transportând autoturism pe platformă în Chișinău, intervenție non-stop"
                }
                className={
                  "h-full max-h-[120px] rounded-2xl object-cover md:object-[50%_50%] md:max-h-[200px]"
                }
                loading="lazy"
            ...
            <div className="col-span-1 h-full drop-shadow-[0_3px_32px_rgba(0,0,0,0.08)]">
              <Image
                src={image2}
                alt={
                  "Evacuator auto transportând SUV pe platformă în Chișinău, intervenție non-stop"
                }
                className={
                  "h-full max-h-[120px] rounded-2xl object-cover object-[50%_40%] md:object-[50%_50%]   md:max-h-[200px]"
                }
                loading="lazy"
                sizes="(max-width: 768px) 100vw, 33vw"
              />
            ...
            <div className="col-span-2 h-full drop-shadow-[0_3px_32px_rgba(0,0,0,0.08)] md:col-span-1 lg:col-span-2">
              <Image
                src={image3}
                alt={
                  "Evacuator auto noaptea în Chișinău, intervenție non-stop pentru tractare vehicule"
                }
                className={
                  "max-h-[120px] rounded-2xl object-cover object-[50%_40%] md:object-[50%_60%] md:max-h-[200px]"
                }
                loading="lazy"
                sizes="(max-width: 768px) 100vw, 33vw"
              />
          ...
          <div className="grid w-full grid-cols-2 gap-4 md:grid-cols-3 md:gap-6 lg:grid-cols-5">
            <div className="col-span-1 h-full drop-shadow-[0_3px_32px_rgba(0,0,0,0.08)]">
              <Image
                src={image6}
                alt={
                  "Evacuator auto Iveco Daily în Chișinău, disponibil pentru intervenții non-stop"
                }
                className={
                  "h-full max-h-[120px] rounded-2xl object-cover object-[50%_50%] md:object-[50%_50%] md:max-h-[200px]"
                }
                loading="lazy"
                sizes="(max-width: 768px) 100vw, 33vw"
              />
            ...
            <div className="col-span-1 h-full drop-shadow-[0_3px_32px_rgba(0,0,0,0.08)] lg:col-span-2">
              <Image
                src={image5}
                alt={
                  "Evacuator auto nonstop în Chișinău, intervenție rapidă 24/7"
                }
                className={
                  "h-full max-h-[120px] rounded-2xl object-cover md:object-[50%_50%] md:max-h-[200px]"
                }
        ...
        <div className={"flex flex-col items-center gap-2"}>
          ...
          >
            Suntem acolo unde este nevoie, pentru evacuare auto rapidă în
            Chișinău.
          </p>
          <AppButton
            className={
