  ...
  return (
    <header className="container">
      ...
      >
        ...
        <span className={"block text-center font-semibold md:hidden"}>
          Disponibili 24/7. Ajungem în 15–20 minute.
        </span>
      </div>
      <div
        className={cn(
      ...
      >
        <div className="w-full justify-self-start">
          <Image
            src={logo}
            alt="Logo"
            className={"max-w-[110px] md:max-w-[200px]"}
          />
        </div>
        ...
        <nav className="font-helvetica-neue hidden gap-4 justify-self-center font-medium lg:flex">
          <Link
            ...
            className={"group default-transition"}
          >
        ...
        <div className="hidden justify-self-end font-medium lg:block">
          <AppButton
            icon={
              <Image src={phone} alt={"Phone icon"} className={"h-3.5 w-3.5"} />
            }
            label={"067 294 661"}
